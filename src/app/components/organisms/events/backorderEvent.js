...
export default function Backorder(props, cookies, markedWorkOrderId, page) {
  const {
    event,
    style,
    textStyle,
      ...
      <div className="trucate" style={{ ...style, ...getOptionsStyle(cookies) }}>
        ...
        <span>
          ...
          <span>
            {ep.description &&
              <>
                <span className="pl-1 text-blue-800 font-semibold">
                  <span className="text-blue-700 font-bold">- {ep?.description}</span>
                </span>
              </>
            }
            ...
            {ep.systemValue &&
              <>
                <span className="pl-1 text-blue-800 font-semibold"></span>
                  <span className="text-blue-700 font-bold">- {ep?.systemValue}
                </span>
              </>
            }
