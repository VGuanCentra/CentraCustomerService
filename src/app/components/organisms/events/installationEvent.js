  ...
  const IconContainer = (props) => {
    ...
    return (
      <span>
        ...
        {ep?.jobDifficulty &&          
          <span className="ml-[3px] pl-[2px] pr-[3px] pb-[2px] align-middle rounded-sm bg-[#000] text-[#FFF] font-bold">
            {ep.jobDifficulty}
          </span>          
        }
        ...
        <Tooltip title={`Number of installers: ${ep?.installerCount}`} className="mr-[4px]">
          {ep?.installerCount && ep?.installerCount > -1 &&
            <span className="ml-[4px] pl-[3px] pr-[1px] pt-[1px] align-middle rounded-full bg-[#6b7280]">
        ...
        {ep?.returnedJob > 0 &&
          <Tooltip title="Returned Job">
            <span><ReturnJobIcon /></span>
          </Tooltip>
        }      
